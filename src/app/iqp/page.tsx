  ...
  return (
    <main className="flex min-h-screen flex-col items-center p-24 gap-5">
      <div className=" w-full flex flex-col items-center justify-between  ">
        <h1 className="text-5xl py-2 text-center">Nitrogen Cycle Public Outreach and Game Development</h1>
        <h2 className="text-lg text-center font-semibold">Iteractive Qualifying Project</h2>
      ...
      <div className="flex flex-row flex-wrap w-full justify-evenly gap-2">
        ...
        <Card className="flex-grow flex">
          <iframe className="flex-grow aspect-a4" src="/iqp.pdf"/>
        </Card>
      </div>
      <div className="flex flex-row flex-wrap w-full justify-evenly gap-2">
        {/* back to main page */}
