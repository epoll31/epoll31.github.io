...
export default function About() {
    return (
        <div className="w-full h-full text-black flex-col overflow-y-auto overflow-x-hidden">
            ...
            <div className="flex-grow flex flex-row justify-around m-5 gap-5 md:m-10 md:gap-10">
                <div className="flex-1 font-k2d flex flex-col text-wrap gap-3">
                    ...
                    <p>
                        ...
                        <CursorLock className="mx-1 whitespace-nowrap text-nowrap w-fit inline hover:font-semibold" cursorLockedClassName="h-1 w-[14.5rem] rounded-full bg-foreground translate-y-2 z-40">
                    ...
                    <p>
                        During the summer of 2022 and 2023, I participated in the software development internship program at
                        <CursorLock className="mx-1 whitespace-nowrap text-nowrap w-fit inline hover:font-semibold" cursorLockedClassName="h-1 w-[6.2rem] rounded-full bg-foreground translate-y-2 z-40">
                    ...
                    <p>
                        ...
                        <CursorLock className="ml-1 whitespace-nowrap text-nowrap w-fit inline hover:font-semibold" cursorLockedClassName="h-1 w-[8rem] rounded-full bg-foreground translate-y-2 z-40">
                            <Link href="https://epic.com">Build-It-Yourself</Link>
                        </CursorLock>
