...
export type Tab = TabProps | "Education" | "Projects" | "Work" | "About" | "Early Years";
...
export function Heading({
    ...
    return (
        <>
            <Link href={"./"} className="text-nowrap md:text-wrap md:w-min font-lilita text-5xl md:text-8xl">Ethan Pollack</Link>
