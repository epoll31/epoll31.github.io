...
export default function MQP() {
  return (
    <>
      <main className="fixed w-screen h-screen overflow-x-hidden flex flex-col">
        <div className="h-fit w-full flex flex-col items-center justify-center py-5 md:m-10" >
          <div className="max-w-prose h-fit">
